      ...
      <main className="max-w-5xl mx-auto pt-28 pb-20 px-4 md:px-8 relative z-10">
        ...
        {orders.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-[#f5f7f8] rounded-[3rem] border border-white/5 shadow-2xl">
            ...
            <h3 className="text-2xl font-serif text-[#2e443c] mb-2">
              Your collection is empty.
            </h3>
            <p className="text-gray-500 text-sm mb-8 font-light">
              Discover our latest artifacts and illuminated designs.
            </p>
            <button
                ...
                >
                  ...
                  <div className="p-6 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gray-50">
                    ...
                    <div className="flex items-start gap-4">
                      <div
                        className={`w-12 h-12 rounded-2xl flex items-center justify-center ${statusConfig.bg} border ${statusConfig.border} shrink-0`}
                      >
                        <i
                          className={`fa-solid ${statusConfig.icon} ${statusConfig.text} text-lg`}
                        ></i>
                      </div>
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span
                            className={`text-[10px] font-bold uppercase tracking-widest ${statusConfig.text}`}
                          >
                            {statusConfig.label}
                          </span>
                        ...
                        (order.trackingInfo.carrier ||
                          ...
                          <div className="mt-4 p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <span className="text-xs font-bold uppercase tracking-wider text-[#a89068]">
                                Tracking Details
                              </span>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                              {order.trackingInfo.carrier && (
                                <div>
                                  ...
                                  <p className="text-[#2e443c] font-medium">
                                    {order.trackingInfo.carrier}
                                  </p>
                                </div>
                              )}
                              {order.trackingInfo.trackingNumber && (
                                <div>
                                  ...
                                  <p className="text-[#2e443c] font-mono text-sm">
                                    {order.trackingInfo.trackingNumber}
                                  </p>
                                </div>
                              )}
                    ...
                    <div className="grid gap-4">
                      {order.items.map((item, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="flex gap-4 items-center group/item hover:bg-white p-2 rounded-xl transition-colors"
                          >
                            <div className="w-16 h-16 md:w-20 md:h-20 rounded-xl bg-white p-2 shrink-0 overflow-hidden border border-gray-200 shadow-sm">
                              <img
                                src={
                                  imgUrl.includes("demo")
                                    ? "https://images.unsplash.com/photo-1550989460-0adf9ea622e2?q=80&w=200"
                                    : imgUrl
                                }
                                alt={name}
