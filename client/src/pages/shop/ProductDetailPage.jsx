              ...
              <div className="mb-8 rounded-2xl border border-[#F5DEB3]/30 bg-[#F5DEB3]/8 px-5 py-4 flex gap-3 items-start">
                ...
                <div>
                  ...
                  <p className="text-[#F5DEB3]/80 text-sm leading-relaxed font-light">
                    We're overwhelmed by the response! Our lamps are currently at their production limit — shipping for new orders starts after <span className="text-[#F5DEB3] font-medium">April 13th</span>. If you're happy to wait for a little extra glow, we'd love for you to place your order!
                  </p>
                </div>
              </div>
            )}
