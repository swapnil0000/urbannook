...
export const UnCashCalculationPage = lazy(
  () => import("./info/UnCashCalculationPage.jsx"),
);
...
export const CancellationPolicy = lazy(
  () => import("./legal/CancellationPolicy.jsx"),
);
...
export const ProductDetailPage = lazy(
  () => import("./shop/ProductDetailPage.jsx"),
);
export const MyProfilePage = lazy(() => import("./account/MyProfilePage.jsx"));
export const CustomerSupportPage = lazy(
  () => import("./support/CustomerSupportPage.jsx"),
);
