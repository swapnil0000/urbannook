      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28">
        ...
        <div className="mb-16 text-center md:text-left border-b border-white/10 pb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 w-fit mb-6 backdrop-blur-md">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-emerald-400">Legal</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4 leading-tight">
            Terms & <span className="italic text-emerald-500/80">Conditions</span>
          </h1>
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">01.</span> Introduction
            </h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">02.</span> Eligibility & Account
            </h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">03.</span> Products & Pricing
            </h2>
            <p className="leading-relaxed text-gray-400 mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">04.</span> Payments & Billing
            </h2>
            <p className="leading-relaxed text-gray-400 mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">05.</span> Shipping, Returns & Cancellations
            </h2>
            <p className="leading-relaxed text-gray-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">06.</span> Intellectual Property
            </h2>
            <p className="leading-relaxed text-gray-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4 flex items-center gap-3">
              <span className="text-emerald-500 text-sm font-sans font-bold">07.</span> Governing Law
            </h2>
            <p className="leading-relaxed text-gray-400">
          ...
          <section className="bg-white/5 p-8 rounded-2xl border border-white/10 mt-12">
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4">Questions regarding Terms?</h2>
            <p className="text-gray-400 mb-6">
              If you have any questions or concerns about these Terms & Conditions, please contact our support team.
            </p>
