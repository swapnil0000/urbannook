      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28">
        ...
        <div className="mb-2 text-left  border-b border-white/10 pb-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 w-fit mb-6 backdrop-blur-md">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-brand">Support</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4 leading-tight">
            Cancellation & <span className="italic text-brand">Refunds</span>
          </h1>
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4">
              <span className='text-brand'> 01.</span> Order Cancellation</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 02.</span> Returns & Replacements</h2>
            <p className="leading-relaxed text-gray-400 mb-4">
              We have a strict <strong>3-day replacement policy</strong> applicable only for damaged, defective, or incorrect items. Since our products are made-to-order or limited batch, we do not accept returns for <span className="font-bold text-brand">"change of mind"</span>.
            </p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 03.</span> Refund Timeline</h2>
