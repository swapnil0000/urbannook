...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="bg-ink min-h-screen text-gray-300 font-sans relative selection:bg-surface selection:text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28">
        ...
        <div className="mb-2 text-left  border-b border-white/10 pb-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 w-fit mb-6 backdrop-blur-md">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-brand">Security</span>
          </div>
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 01.</span> What We Collect</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 02.</span> Consent</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 03.</span> Disclosure</h2>
            <p className="leading-relaxed text-gray-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 04.</span> Third-Party Services</h2>
            <p className="leading-relaxed text-gray-400 mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-brand'> 05.</span> Security</h2>
            <p className="leading-relaxed text-gray-400">
