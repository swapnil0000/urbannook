      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28">
        ...
        <div className="mb-2 text-left  border-b border-white/10 pb-4">
          ...
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4 leading-tight">
            Privacy <span className="italic text-[#F5DEB3]">Policy</span>
          </h1>
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-[#F5DEB3]'> 01.</span> What We Collect</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg border border-white/5">
                    <h3 className="text-[#a89068] font-bold text-sm mb-1">Identity Data</h3>
                    <p className="text-xs text-gray-400">Name, Username, Shipping Address</p>
                </div>
                <div className="bg-white p-4 rounded-lg border border-white/5">
                    <h3 className="text-[#a89068] font-bold text-sm mb-1">Contact Data</h3>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-[#F5DEB3]'> 02.</span> Consent</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-[#F5DEB3]'> 03.</span> Disclosure</h2>
            <p className="leading-relaxed text-gray-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-[#F5DEB3]'> 04.</span> Third-Party Services</h2>
            <p className="leading-relaxed text-gray-400 mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-serif text-white mb-4"><span className='text-[#F5DEB3]'> 05.</span> Security</h2>
            <p className="leading-relaxed text-gray-400">
