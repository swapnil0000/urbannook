...
const AireHeroBanner = memo(() => {
  ...
  return (
    <section className="relative min-h-[42vh] sm:min-h-[60vh] lg:h-[calc(100vh-2rem)] lg:max-h-[900px] mx-2 md:mx-4 rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl flex items-center group bg-[#1a2822]">
