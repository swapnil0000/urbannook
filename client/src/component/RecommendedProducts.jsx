    ...
    <section className="mt-8 sm:mt-12 md:mt-16 px-4 lg:px-12 pt-4 sm:pt-6">
      <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 sm:gap-6">
        {/* <div className="flex-1">
          <span className="text-paper font-bold tracking-[0.2em] uppercase text-[16px]">
            Handpicked for you
          </span>
        ...
        {/* <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="w-10 h-10 rounded-full flex items-center justify-center bg-paper/10 text-paper border border-paper/25 hover:bg-paper hover:text-ink active:scale-95 transition-all"
          >
