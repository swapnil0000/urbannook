      ...
      <div className="w-full text-center">
        ...
        <div className="mt-4 flex items-center justify-center gap-4 text-xs">
          <button
            ...
            className="gl-lbl text-[10px] text-brand hover:underline"
          >
            Open WhatsApp again
          </button>
          <button
            ...
            className="gl-lbl text-[10px] text-faint hover:text-ink"
          >
            Cancel
          </button>
        </div>
  ...
  return (
    <div className="w-full">
      <button
        ...
        onClick={handleClick}
        disabled={isStarting}
        className="w-full flex items-center justify-center gap-3 rounded-lg border border-hair bg-white px-4 py-2.5 text-sm font-bold text-ink transition-colors hover:bg-surface disabled:cursor-not-allowed disabled:opacity-60"
      >
        {isStarting ? (
