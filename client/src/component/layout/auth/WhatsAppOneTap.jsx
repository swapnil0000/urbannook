...
export default function WhatsAppOneTap() {
  ...
  return (
    ...
    >
      <div className="rounded-2xl bg-white shadow-2xl border border-hair p-4 flex items-center gap-3">
        <div className="shrink-0 w-10 h-10 rounded-full bg-surface border border-hair flex items-center justify-center">
        ...
        <button
          ...
          onClick={handleClick}
          disabled={isStarting}
          className="gl-press shrink-0 rounded-full bg-brand px-4 py-2 gl-lbl text-[10px] text-white
        ...
        <button
          ...
          onClick={dismiss}
          aria-label="Dismiss"
          className="shrink-0 w-7 h-7 rounded-full text-faint hover:text-ink transition-colors"
        >
