  ...
  return (
    <section className="relative min-h-[97vh] lg:h-[calc(100vh-2rem)] lg:max-h-[900px] mx-2 my-2 md:mx-4 md:my-4 rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden shadow-2xl flex items-center group">
      ...
      <div className="absolute inset-0 z-0">
        {/* NOTE: Ensure '/assets/hero.png' exists in your public folder.
           If the screen is black, it means this path is wrong. 
           I added a fallback Unsplash image just in case for testing.
        */}
        <img 
          src="/assets/hero.png" 
          onError={(e) => {
            e.target.onerror = null; 
            e.target.src="https://images.unsplash.com/photo-1618220179428-22790b461013?q=80&w=2500&auto=format&fit=crop";
          }}
          alt="Hero Background" 
        ...
        {/* --- GRADIENT OVERLAY (The "Scrim") --- 
            This ensures text is readable on the left, but the image shines through on the right.
        */}
      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-20 py-12">
        <div className="w-full max-w-7xl mx-auto">
          ...
          {/* LEFT SIDE CONTENT CONTAINER (Max Width constrained) */}
          <div className="max-w-2xl space-y-8 flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 shadow-sm w-fit">
              ...
              <span className="text-[10px] font-bold tracking-widest uppercase text-white">New Collection 2024</span>
            </div>
            ...
            <p className="text-base md:text-lg text-stone-200 leading-relaxed font-medium drop-shadow-md">
            ...
            <div className="pt-8 flex items-center justify-center sm:justify-start gap-12 w-full border-t border-white/10 mt-4">
                <div className="text-center sm:text-left">
                    <p className="text-3xl font-serif italic text-white">25k+</p>
