...
const AireInstagramFeed = () => {
    return (
      ...
      `}</style>
            ...
            <div className="w-[98%] max-w-[1500px] bg-[#0a110e] rounded-[40px] overflow-hidden relative flex flex-col p-8 md:p-14 shadow-2xl border border-white/5">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between  gap-6">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className="text-emerald-500 font-bold tracking-[0.2em] uppercase text-[10px]">Instagram Gallery</span>
                            </div>
                            <h2 className="text-3xl md:text-5xl font-serif text-white leading-[0.95]">
                                ...
                                <span className="relative inline-block">
                                    ...
                                    <svg
                                        className="absolute w-full h-1 -bottom-1 left-0 text-emerald-500 -z-0"
                                        viewBox="0 0 100 10"
                            ...
                            <div className="flex items-center gap-4 bg-white/5 pr-5 pl-2 py-1.5 rounded-2xl border border-white/5 backdrop-blur-sm max-w-md">
                                ...
                                <div className="flex flex-col">
                                    <p className="text-white font-serif text-sm leading-tight">
                                        Join the <span className="italic text-emerald-300">Movement.</span>
                                    </p>
