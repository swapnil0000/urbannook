            ...
            <>
              ...
              <div className="space-y-6">
                {cartItems.map((item) => {
                  ...
                  return (
                    <div key={`${itemId}-${itemVariant}`} className="flex items-stretch gap-4 group relative pb-6 border-b border-gray-50 last:border-0 last:pb-0">
                      ...
                      <div className="flex-1 flex flex-col min-w-0 justify-between min-h-[85px]">
                        ...
                        <div>
                          ...
                          <div className="flex justify-between items-start mb-1">
                            ...
                            <button
                              onClick={() => handleRemoveItem(itemId, itemVariant, item.mongoId)}
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <div className="flex items-center gap-4 bg-white border border-gray-200 rounded-full h-8 px-3 shadow-sm">
                            <button
                              onClick={() => handleQuantityChange(itemId, itemVariant, Math.max(0, itemQty - 1), item.mongoId, itemQty, item.image)}
                            ...
                            <button
                              onClick={() => handleQuantityChange(itemId, itemVariant, itemQty + 1, item.mongoId, itemQty, item.image)}
                              className="w-4 h-full flex items-center justify-center text-gray-400 hover:text-[#0a110e] transition-colors"
                            >
