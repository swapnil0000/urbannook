...
// Background image
const desktopBgImage = "/assets/chooseus.png"
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* 2. NEW CONTENT TO FILL SPACE (Stats / Trust Badges) */}
          ...
          {/* 3. SCROLL INDICATOR (Connects Text to Cards) */}
            ...
            >
              ...
              <div className="relative z-10 h-full p-8 md:p-12 lg:p-16 flex flex-col justify-between">
                ...
                <div className="space-y-4">
                  ...
                  {/* Title */}
                  <h3 className="text-1xl md:text-2xl font-serif font-medium leading-tight">
                    {feature.title}
                  </h3>
                </div>

                {/* --- BOTTOM SECTION --- */}
                <div className="flex items-end justify-between gap-6 pt-4 border-t border-opacity-11">
                   <p className="text-sm md:text-base font-light leading-relaxed opacity-80 max-w-sm">
                      {feature.description}
                   </p>
                   
                   <div className="hidden sm:flex w-10 h-10 md:w-12 md:h-12 rounded-full border border-current border-opacity-20 items-center justify-center opacity-70 hover:opacity-100 hover:bg-current hover:bg-opacity-5 transition-all cursor-pointer shrink-0">
                      <i className="fa-solid fa-arrow-right -rotate-45 text-xs md:text-sm"></i>
                   </div>
                </div>
