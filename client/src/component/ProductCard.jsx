...
const ProductCard = ({ product, index = 0, listId = "all_products", listName = "All Products" }) => {
  ...
  return (
    <div className="group relative rounded-[1.6rem] overflow-hidden bg-black/20 border border-white/5 shadow-lg hover:shadow-2xl hover:border-paper/30 transition-all duration-500 flex flex-col h-full">
      ...
      >
        <div className="relative w-full aspect-square bg-[#f8f8f5] overflow-hidden">
          ...
          {(() => {
            ...
            return totalLeft === 1 ? (
              <span className="absolute top-3 left-3 z-10 flex items-center gap-1 text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-md bg-paper text-ink shadow animate-pulse">
                <i className="fa-solid fa-bolt text-[9px]" /> Only 1 left
              </span>
            ) : (
              <span className="absolute top-3 left-3 z-10 flex items-center gap-1 text-[10px] font-black uppercase tracking-wider px-2.5 py-1 rounded-md bg-ink text-paper border border-paper/30 shadow">
        ...
        <div className="p-4 md:p-4 flex flex-col flex-grow bg-[#f5f7f8] to-transparent backdrop-blur-md">
          ...
          <div className="flex justify-between items-end pt-2 border-t border-paper/10] gap-2">
            ...
            <div className="hidden md:flex w-12 h-12 rounded-full bg-paper/10 text-gray-500 items-center justify-center group-hover:bg-paper group-hover:text-ink transition-all duration-300">
