        ...
        <div className="min-h-screen bg-[#d8c8b8] flex justify-center items-center py-4 sm:py-6 md:py-6 font-['Patrick_Hand'] text-[#3e2b1e] px-2 sm:px-4">
          ...
          ${toast.type === "success" ? "bg-[#eaddca] text-green-800 border-green-700" : "bg-[#D1C4C4] text-red-900 border-red-800"}`}
            ...
            >
                ...
                {/* Top-left: "your smile" sticker */}
                    <div className=" absolute w-[200px] ">
                    <img
                        src="/templates/testup.png"
          ...
          You make me happy in a way no one else can. <span aria-hidden>💕</span>
                ...
                {/* "I love making you laugh" sticker */}
          ...
          And then you came along, and my life became beautiful. <span aria-hidden>🌸</span>
                ...
                <div
                    ...
                    className={`absolute top-[8%] right-[2%] w-[200px] sm:w-[200px] h-[200px] sm:h-[200px] bg-white p-1 rotate-[-5deg] z-10 transition-transform ${PHOTO_SHADOW} ${!userDetails?.isLocked ? "cursor-pointer hover:scale-105 ring-2 ring-[#c25e5e]/40 hover:ring-[#c25e5e]/70" : ""}`}
                >
                    <img
                        src={getImageSrc(1)}
                        alt="Memory 2"
          ...
          <span className="text-lg" aria-hidden>🖤</span>
                ...
                {/* "You're mine" stacked labels */}
                <div className="absolute top-[35%] left-[58%] bg-[#c25e5e] text-white px-2 text-[9px] rotate-[5deg] font-bold shadow-sm z-0 opacity-95">
                    You&apos;re mine, Again. <span aria-hidden>🧿</span>
                </div>
                <div className="absolute top-[37%] left-[59%] bg-[#a84a4a] text-white px-2 text-[9px] rotate-[-2deg] font-bold shadow-sm z-0">
          ...
          A million times over, I will always choose you. <span aria-hidden>💖</span>
                ...
                {/* "I ONLY WANT TWO THINGS" sticker */}
                <div className={`absolute top-[40%] right-[19%] bg-[#eaddca] p-2 text-[8px] sm:text-[9px] w-28 text-center rotate-[-3deg] font-handwritten z-0 ${STICKER_SHADOW} noise-bg`}>
                ...
                <div className=" absolute max-w-25 max-h-25 top-[36%] left-[80%]">
                    <img
          ...
          />
                ...
                {/* "I got lost in him" */}
                <div className="absolute bottom-[26%] left-[10%] bg-[#d0c8b8] p-2 w-36 sm:w-40 font-['Permanent_Marker'] text-[10px] sm:text-[11px] rotate-[0deg] border-l-4 border-[#3e2b1e] shadow-sm z-0 noise-bg">
