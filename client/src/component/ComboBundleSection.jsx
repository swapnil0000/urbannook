            ...
            <div className="absolute bottom-0.5 sm:bottom-1 left-0 right-0 flex items-center justify-center gap-0.5">
                ...
                return (
                  <button
                    ...
                    className={`w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 rounded-full overflow-hidden border shadow flex items-center justify-center bg-white shrink-0 transition-transform hover:scale-110 ${
                      isSelected ? "border-paper" : "border-white/70"
                    }`}
                  >
                    {type === "color" && value ? (
              ...
              {showOverflow && (
                <button
                  ...
                  title="More variants"
                  className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 rounded-full bg-ink border border-white/70 shadow flex items-center justify-center text-[5px] sm:text-[6px] font-bold text-paper shrink-0 hover:scale-110 transition-transform"
                >
                  +{overflowCount}
                </button>
              )}
              ...
              return (
                ...
                >
                  <div className="w-2.5 sm:w-3.5 shrink-0 flex justify-center pt-[calc(50%-1.5rem)]">
                    <span className="text-paper text-[19px] sm:text-[19px]">
                      +
                    </span>
                  </div>
                  <BundleTile
