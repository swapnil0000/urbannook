    ...
    <table width="600" cellpadding="0" cellspacing="0" role="presentation" class="bg-card"
      ...
      <tr>
        <td align="center" class="pad-mobile" style="padding:44px 48px 16px;">
          ...
          <p class="b-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; color:#666666; line-height:1.75; max-width:420px;">
            Hi <strong class="h-text" style="color:#141414;">${userName}</strong>, we&#8217;re thrilled to have you as part of our community. A warm, aesthetic space awaits you.
          </p>
        </td>
      </tr>
      ...
      <tr>
        <td class="pad-mobile" style="padding:32px 40px 8px;">
          <p class="h-text" style="margin:0 0 18px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:9px; font-weight:700; color:#141414; text-transform:uppercase; letter-spacing:3px;">
            What&#8217;s Next
          </p>
            ...
            <tr>
              <td style="padding:0 0 14px;">
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="divider" style="width:6px; height:6px; background-color:#E63329; vertical-align:top; padding-top:5px; padding-right:14px;"></td>
            ...
            <tr>
              <td style="border-top:1px solid #D8D2C5; padding-top:20px;">
                ...
                <p class="m-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:12px; color:#888888; line-height:1.7;">
                  <a href="https://www.instagram.com/urbannook.store" target="_blank" class="h-text" style="color:#141414; text-decoration:none; font-weight:600;">@urbannook.store</a>
                  &nbsp;&middot;&nbsp;
                  <a href="https://urbannook.in" target="_blank" class="h-text" style="color:#141414; text-decoration:none;">urbannook.in</a>
                </p>
              </td>
            </tr>
          </table>
