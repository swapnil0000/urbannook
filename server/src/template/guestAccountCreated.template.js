      ...
      <tr>
        <td align="center" class="pad-mobile" style="padding:44px 48px 16px;">
          ...
          <p class="b-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; color:#666666; line-height:1.75; max-width:420px;">
            Hi ${userName}, your order <strong class="h-text" style="color:#141414;">#${orderId}</strong> has been confirmed and is being prepared. Thank you for shopping with UrbanNook.
          </p>
        </td>
      </tr>
              ...
              <td style="padding:24px 28px;">
                ...
                <table cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    ...
                    <td class="h-text" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; font-weight:600; color:#141414; padding-bottom:14px;">${email}</td>
                  </tr>
                  <tr>
                    ...
                    <td style="font-family:'Courier New',Courier,monospace; font-size:14px; font-weight:700; color:#141414; background-color:#D8D2C5; padding:3px 10px; display:inline-block;">${tempPassword}</td>
                  </tr>
                </table>
              </td>
            </tr>
