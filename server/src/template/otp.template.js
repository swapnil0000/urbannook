      ...
      <tr>
        <td align="center" style="padding:0 40px 36px;">
          <table cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="divider" style="border:1px solid #F5DEB3; padding:24px 48px;">
                ...
                <p class="h-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:36px; font-weight:700; color:#2E443C; letter-spacing:10px; text-align:center;">
                  ${otp}
                </p>
              </td>
            </tr>
      ...
      <tr>
        <td class="pad-mobile" style="padding:32px 40px 40px;">
          <p class="b-text" style="margin:0 0 20px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; color:#666666; line-height:1.75;">
            <strong class="h-text" style="color:#2E443C;">This OTP will expire in 10 minutes.</strong><br/>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="bg-soft divider" style="border-left:3px solid #F5DEB3; padding:14px 20px; background-color:#F7F4EF;">
                <p class="b-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:12px; color:#666666; line-height:1.7;">
                  <strong class="h-text" style="color:#2E443C;">Security Notice:</strong> Never share this OTP with anyone. UrbanNook will never ask for your OTP via phone or email.
                </p>
              </td>
            </tr>
          </table>
