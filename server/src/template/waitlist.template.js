          ...
          <table cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="padding:0 10px;">
                <a href="https://www.instagram.com/urbannook.store" target="_blank" class="h-text" style="color:#141414; font-weight:600; text-decoration:none; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px;">
                  Instagram
                </a>
              </td>
              <td class="m-text" style="color:#E63329;">&middot;</td>
              <td style="padding:0 10px;">
                <a href="https://www.youtube.com/" target="_blank" class="h-text" style="color:#141414; font-weight:600; text-decoration:none; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px;">
                  YouTube
                </a>
              </td>
            </tr>
