export const generateInvoiceHtmlTemplate = (order) => {
  ...
  <head>
    <meta charset="UTF-8" />
    <style>
      body { font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; background-color: #EFEAE0; padding: 30px; margin: 0; }
      .card { max-width: 850px; margin: 0 auto; background: #fff; border: 1px solid #D8D2C5; overflow: hidden; }
      .header { background: #141414; padding: 32px 40px; display: flex; justify-content: space-between; align-items: center; }
      ...
      .section-title { font-weight: 700; color: #141414; border-bottom: 1px solid #E63329; margin-bottom: 10px; padding-bottom: 6px; text-transform: uppercase; font-size: 9px; letter-spacing: 2px; }
      .info-text { font-size: 13px; line-height: 1.6; margin: 0; color: #444; }
      table { width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 13px; }
      th { background: #E5DFD3; color: #141414; padding: 12px; text-align: left; font-size: 9px; text-transform: uppercase; letter-spacing: 1.5px; border-bottom: 1px solid #E63329; }
      td { padding: 12px; border-bottom: 1px solid #D8D2C5; color: #444; }
      .totals-wrapper { display: flex; justify-content: flex-end; margin-top: 30px; }
      .totals-box { background: #E5DFD3; border: 1px solid #E63329; padding: 20px; width: 250px; }
      .totals-row { display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 14px; color: #444; }
      .grand-total { font-weight: 700; color: #141414; border-top: 1px solid #141414; padding-top: 10px; margin-top: 10px; font-size: 16px; }
    ...
    <div class="card">
      <div class="header">
        ...
        <div style="text-align: right;">
          <h2 style="margin:0; font-size:16px; color:#E63329; font-weight:600; letter-spacing:1px;">INVOICE</h2>
