    ...
    <table width="600" cellpadding="0" cellspacing="0" role="presentation" class="bg-card"
      ...
      <tr>
        <td align="center" style="padding:8px 40px 40px;">
          <table cellpadding="0" cellspacing="0" role="presentation" class="bg-soft" style="border:1px dashed #E63329; background-color:#E5DFD3;">
            <tr>
              <td align="center" style="padding:20px 44px;">
                ...
                <p class="h-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:26px; font-weight:700; color:#141414; letter-spacing:3px;">
