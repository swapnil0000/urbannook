      ...
      <tr>
        <td style="padding:0 40px 8px;">
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              ${steps.map((step, i) => `
              <td align="center" class="${i <= currentStepIndex ? 'h-text' : 'm-text'}" style="padding:0 0 10px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:9px; font-weight:700; text-transform:uppercase; letter-spacing:1.5px; color:${i <= currentStepIndex ? '#141414' : '#CCCCCC'}; border-bottom:2px solid ${i <= currentStepIndex ? '#141414' : '#D8D2C5'};">
                ${stepLabels[step]}
              </td>`).join('')}
            </tr>
          </table>
    ...
    <table width="600" cellpadding="0" cellspacing="0" role="presentation" class="bg-card"
      ...
      <tr>
        <td align="center" class="pad-mobile" style="padding:44px 48px 16px;">
          ...
          <h2 class="h-text" style="margin:20px 0 16px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:27px; font-weight:600; color:#141414; line-height:1.25; letter-spacing:-0.3px;">
            ${config.title}
          </h2>
