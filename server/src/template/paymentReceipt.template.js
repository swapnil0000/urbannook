    ...
    <table width="600" cellpadding="0" cellspacing="0" role="presentation" class="bg-card"
      ...
      <tr>
        <td align="center" style="padding:8px 40px 40px;">
          ...
          <p class="h-text" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:38px; font-weight:700; color:#141414;">
            &#8377;${amount}
          </p>
        </td>
      </tr>
        ...
        <td class="pad-mobile" style="padding:32px 40px 40px;">
          ...
          <table cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              ...
              <td class="h-text" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; font-weight:600; color:#141414; padding-bottom:14px;">#${orderId}</td>
            </tr>
            <tr>
              ...
              <td class="h-text" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; font-weight:600; color:#141414; padding-bottom:14px;">${paymentId}</td>
            </tr>
            <tr>
              ...
              <td class="h-text" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; font-weight:600; color:#141414; padding-bottom:14px;">${methodLabel}</td>
            </tr>
            <tr>
              ...
              <td class="h-text" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; font-weight:600; color:#141414;">${formattedDate}</td>
            </tr>
            ${balanceDueRow}
          </table>
        </td>
